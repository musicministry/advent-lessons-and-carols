...
::: {.callout-note}
Most Lessons and Carols programs are 90 min to 2 hours long, so we are far from abnormal even with nine lessons. Also, the pageant scenes likely only overlap with the second half of this, so the kids would only have "acting" roles for ~40 min.
:::
