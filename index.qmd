...
This site outlines a **draft** program for a proposed **Advent Festival of Lessons, Carols, and Pageantry** that combines a traditional [Advent Lessons and Carols](https://www.usccb.org/prayer-and-worship/liturgical-year-and-calendar/advent/festival-of-lessons-and-carols), popularized by [King's College in Cambridge](https://www.youtube.com/watch?v=j9Tz1QgRs5Y), with St. Egbert School's traditional Christmas pageant. This is merely a starting point to consider and, possibly, for us to build upon and iterate through.
...
Lessons and Carols is a lot of music, as the name implies, but with a couple exceptions, all songs and hymns here are familiar to the parish/choir. [Mary, Did You Know](https://www.youtube.com/watch?v=F1H1-scfD1s) was included upon request from the kids. We will need to purchase this if we use it.
...
**Use the side bar at the left or the navigation links at the bottom of each page to review the outline.**